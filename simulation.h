 ...
 */
    ...
    {
    public:
        Simulation(int width, int height, std::unique_ptr<Canvas> canvas, std::unique_ptr<StatisticsHandler> statisticsHandler);
    ...
    private:
        ...
        std::unique_ptr<StatisticsHandler> _statisticsHandler;
        bool running = false;
